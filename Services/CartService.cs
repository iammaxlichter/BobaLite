...
using BobaLite.DTOs;
using BobaLite.Data;    // IProductRepository lives here
...
namespace BobaLite.Services
{
    public class CartService : ICartService
    {
        ...
        public CartDto GetCart()
        {
            ...
            // rehydrate images + unit prices from the database for every item:
        ...
        public void UpdateQuantity(int productId, string attribute, int quantity)
        {
            ...
            else
            {
                ...
                // ensure imgUrl & ProductName remain set
                // (we already set them when the item was first added)
            }
